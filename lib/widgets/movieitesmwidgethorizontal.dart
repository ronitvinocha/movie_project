...
class MovieListHorizontalItem extends StatelessWidget {
  const MovieListHorizontalItem({required this.movie, super.key});
              ...
              LayoutBuilder(builder: ((context, constraints) {
                return ClipRRect(
                  ...
                  child: CachedNetworkImage(
                    ...
                    height: 350,
                    imageUrl:
                        "${AppConstantString.imageBaseUrl}w${Utils.getNextMultiple(constraints.maxWidth.ceil())}${movie.posterPath}",
                  ),
                );
              })),
              Positioned(
